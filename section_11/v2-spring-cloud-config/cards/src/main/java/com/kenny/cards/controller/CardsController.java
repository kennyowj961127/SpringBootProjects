package com.kenny.cards.controller;
...
import com.kenny.cards.dto.ErrorResponseDto;
import com.kenny.cards.dto.ResponseDto;
...
@Tag(name = "CRUD REST APIs for cards", description = "The Cards API")
@RestController
@RequestMapping("/api")
@Validated
